...
option3.setAttribute("onclick","SquareMaker()");
...
sketch.setAttribute("style",`align-self: center; background-color: white; height: 50rem; width: 50rem; display:grid; grid-template-columns: repeat(${chosenSize}, 1fr);  grid-template-rows: repeat(${chosenSize}, 1fr);`);
